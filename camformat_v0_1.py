...
class CamFormatAddonPrefs(bpy.types.AddonPreferences):
    ...
    camformatD_res_pct = bpy.props.IntProperty(default=50, min=1, max=100, subtype='PERCENTAGE')
...
def register():
    ...
    bpy.types.Camera.camformat_res_pct = bpy.props.IntProperty(default=50, min=1, max=100, subtype='PERCENTAGE', update=update_copy_from_cam)
